...
async function createTables(db) {
  await db.exec(`
    CREATE TABLE IF NOT EXISTS anime (
      ...
      name TEXT,                             -- original name extracted from title by anitomy or ai
      name_jp TEXT,                          -- japan name searched from anilist api (nyaa only)
      name_cn TEXT,                          -- chinese name from mikan (mikan only)
