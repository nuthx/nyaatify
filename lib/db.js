...
async function createTables(db) {
  await db.exec(`
    CREATE TABLE IF NOT EXISTS anime (
      ...
      name TEXT,                             -- anime name extracted from title by anitomy or ai
      name_jp_anilist TEXT,                  -- anime name searched from anilist api
      cover_anilist TEXT,                    -- cover image url from anilist api
